 ...
 */
@Component
public class AlumnoResourceAssemblerLazy extends ResourceAssemblerSupport<Alumno, AlumnoResource> {
	...
	@Autowired
	public AlumnoResourceAssemblerLazy(EntityLinks entityLinks) {
