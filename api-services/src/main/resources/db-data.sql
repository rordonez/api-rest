...
INSERT INTO pfc (nombre, departamento, fechaInicio, estado, directorAcademico) VALUES ('Tecnologías de la Innovación', 'Lenguajes y Ciencias de la Computacion', '2001-09-23', 'FINALIZADO', null);
INSERT INTO pfc (nombre, departamento, fechaInicio, estado, directorAcademico) VALUES ('Genoma Humano', 'Matemática aplicada', '2004-09-23', 'SIN_ASIGNAR', 2);
...
INSERT INTO alumno (dni, pfc, nombre, apellidos, titulacion, domicilio, localidad, pais, codigoPostal, telefono, email, fechaNacimiento) VALUES ('11223344P', null, 'Antonio', 'Silva', 'SISTEMAS', 'sdag', 'sdgdsb', 'sdag', '23532', '3463426', 'asdg', '2014-01-29');
INSERT INTO alumno (dni, pfc, nombre, apellidos, titulacion, domicilio, localidad, pais, codigoPostal, telefono, email, fechaNacimiento) VALUES ('67584937P', null, 'Pedro', 'Aruguedo', 'GESTION', 'Plaza de la Constitución, 25', 'Málaga', 'España', '35633', '678345789', 'E@e.es', '1978-02-04');
INSERT INTO alumno (dni, pfc, nombre, apellidos, titulacion, domicilio, localidad, pais, codigoPostal, telefono, email, fechaNacimiento) VALUES ('36452832O', null, 'Jason', 'Cage', 'SUPERIOR', 'Gran vía, 353', 'Madrid', 'España', '34789', '678343234', 'edt@fsgh.es', '1985-04-22');
INSERT INTO alumno (dni, pfc, nombre, apellidos, titulacion, domicilio, localidad, pais, codigoPostal, telefono, email, fechaNacimiento) VALUES ('12378934Y', null, 'Irene', 'Perez Cantos', 'GESTION', 'Avenida de Manoteras, 34', 'Madrid', 'España', '34532', '678678678', 'esdg@df.com', '1988-08-14');
INSERT INTO alumno (dni, pfc, nombre, apellidos, titulacion, domicilio, localidad, pais, codigoPostal, telefono, email, fechaNacimiento) VALUES ('78453903H', null, 'Miguel', 'Guinzo', 'SUPERIOR', 'Calle de Santalucía, S/N', 'Oviedo', 'España', '34532', '678980839', 'ewavg@sg.es', '1987-02-02');
INSERT INTO alumno (dni, pfc, nombre, apellidos, titulacion, domicilio, localidad, pais, codigoPostal, telefono, email, fechaNacimiento) VALUES ('65793212S', null, 'Alvaro', 'Prat', 'SUPERIOR', 'Calle Benito Pérez Galdos, 2', 'Málaga', 'España', '34532', '648732345', 'example@e.com', '1980-01-21');
INSERT INTO alumno (dni, pfc, nombre, apellidos, titulacion, domicilio, localidad, pais, codigoPostal, telefono, email, fechaNacimiento) VALUES ('23478932E', null, 'Heiko', 'Russianen', 'SISTEMAS', 'sdag', 'sdgdsb', 'sdag', '23532', '3463426', 'asdg', '2014-01-29');